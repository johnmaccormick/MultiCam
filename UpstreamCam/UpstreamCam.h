...
EXTERN_C const GUID CLSID_UpstreamCam;

class CUpstreamCamStream;
class CUpstreamCam : public CSource
{
public:
    //////////////////////////////////////////////////////////////////////////
    //  IUnknown
	...
	virtual ~CUpstreamCam();
	private:
	//ofstream m_debugOut;
	////////////////////////////// end jmac /////////////

private:
    CUpstreamCam(LPUNKNOWN lpunk, HRESULT *phr);
...
// 1. from ??
    ...
    virtual void RegisterPerfId()
         {m_idTransInPlace = MSR_REGISTER(TEXT("UpstreamCam"));}
#endif // PERF
...
class CUpstreamCamStream : public CSourceStream, public IAMStreamConfig, public IKsPropertySet
{
public:
    ...
    //  CSourceStream
    //////////////////////////////////////////////////////////////////////////
    CUpstreamCamStream(HRESULT *phr, CUpstreamCam *pParent, LPCWSTR pPinName);
    virtual ~CUpstreamCamStream();
